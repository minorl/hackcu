    ...
    def validateMove(self,move):
        ...
        if move.typ=="build" and (self.gameState.phase== 'buildsettle' or self.gameState.phase== 'buildroad'):
            ...
            if not self.checkLocation(move.playerid,move.structure,move.location, 'standard'):
                return False
            return True
        elif move.typ=="getdevelopment" and self.gameState.phase== 'standard':
        ...
        elif move.typ=="playdevelopment" and self.gameState.phase== 'standard':
            playerDevs = self.gameState.players[move.playerid].cards
            return self.gameState.players[move.playerid].cards[move.card] >0
